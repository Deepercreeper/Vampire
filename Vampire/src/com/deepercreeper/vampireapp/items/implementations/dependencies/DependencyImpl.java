...
public class DependencyImpl implements Dependency
{
	...
	private final boolean mCreationDependency;
	 ...
	 * @param aValues
	 *            The values map.
	 * @param aCreationdependency
	 *            Whether this dependency is a creation only dependency.
	 */
	public DependencyImpl(final Type aType, DestinationType aDestinationType, final String aItem, final SparseIntArray aValue,
			SparseArray<int[]> aValues, boolean aCreationdependency)
	{
		mType = aType;
		...
		mValue = aValue;
		mValues = aValues;
		mCreationDependency = aCreationdependency;
	}
	...
	@Override
	public boolean isCreationDependency()
	{
		return mCreationDependency;
	}
